...
_‘Users of this International Standard may reproduce subclauses 5.2, 5.3, 5.4 and 5.6 as part of any
process assessment model or maturity model so that it can be used for its intended purpose.’_
...
_‘Users of this part of ISO/IEC 15504 may freely reproduce the detailed descriptions contained in the
exemplar assessment model as part of any tool or other material to support the performance of
process assessments, so that it can be used for its intended purpose.’_
...
[http://www.vda-qmc.de](http://www.vda-qmc.de) web site. It is not permitted for the recipient to further distribute the document.

**Change requests**

Any problems or change requests should be reported through the defined mechanism at the
[http://www.vda-qmc.de](http://www.vda-qmc.de) web site.


© VDA Quality Management Center (^3)
**Trademark notice**
Automotive SPICE® is a registered trademark of the Verband der Automobilindustrie e.V. (VDA)
For further information about Automotive SPICE® visit [http://www.vda-qmc.de.](http://www.vda-qmc.de.)
**Document history**
...
3.1 2017 - 11 - 01 VDA QMC WG13 Changes: See [http://www.automotivespice.com](http://www.automotivespice.com)
**4.0 2023 - 10 - 20 VDA QMC WG13 Complete revision of PAM**
...
- Figure 1 — Process assessment model relationship List of Figures
...
- Table 1 — Terminology List of Tables
...
_NOTE: Depending on the application, e.g., the populated
PCB, a system-on-chip, a microcontroller, or an SBC can be
considered a HW component._
Hardware
element
...
SPICE **S** ystems **P** rocess **I** mprovement and **C** apability d **E** termination
SUG **S** pice **U** ser **G** roup
USB **U** niversal **S** erial **B** us
WP **W** ork **P** roduct
WPC **W** ork **P** roduct **C** haracteristic
_Table 2 — Abbreviation List_
...
```
- **Capab ility l ev el s**
- **Pr oc es s a tt r ibut es**
- **R at ing**
    - **Sc al e**
    - **Rating method**
    - **Agg regation meth od**
- **Proces s capabil ity level model**

```
Pr oc es s2 Pr oc es s3 Pr oc es s ...
```
```
Process assessment mode l
(Automotive SPICE)
```
- **Process capability indicato rs**
...
**Sys tem Engineering Proces s Group (SYS)**
Requirements Elici tation **SYS. 1**
System Requirements **SYS. 2**
Analysis
Syst em A r chit ec tur al **SYS. 3**
Design
System Integration and **SYS. 4**
Integration Verification
**SYS. 5**
System Verification
**Primary Lifecycle Processes Organizational Lifecycle Processes Supporting Lifecycle Processes
Hardware Engineering Process G roup (HWE)
HW E. 1**
HW Requirements
Analysis
**HW E. 2**
...
Machine Learning **MLE.**
Model Testing
**Acq u is ition P rocess
Group (ACQ)
ACQ.**
Supplier Monitoring
**Supply Process G roup
(SPL)
SPL.**
Product Release
**Supporting Proces s Group
(SUP)
SUP.**
Quality Assurance
Configuration **SUP.**
Ma nagement
Problem Resolution **SUP.**
Ma nagement
Change Request **SUP.**
Ma nagement
Machine Learning Data **SUP.**
Ma nagement
**Reuse Process Group
(REU)**
Management of Products for **REU. 2**
Reuse
**Process Improvement
Process Group (PIM)**
...
Analysis
Soft wa re A rc hite c tur al **SWE.**
Design
Software Detailed D esign **SWE.**
and Unit Construction
Software Uni t Verification **SWE.**
Software Component Verification **SWE.**
and Integration Verification
**SWE.**
Software Verificatio n
_Figure 2 — Automotive SPICE process reference model - Overview_
**3.1.1. Primary life cycle processes category**
...
_Table 3 — Primary life cycle processes – ACQ process group_
...
_Table 4 — Primary life cycle processes – SPL process group_
...
_Table 5 — Primary life cycle processes – SYS process group_
...
**VAL.1** Validation
_Table 6 — Primary life cycle processes – VAL process group_
...
_Table 7 — Primary life cycle processes – SWE process group_
...
_Table 8 — Primary life cycle processes – MLE process group_
...
_Table 9 — Primary life cycle processes – HWE process group_
**3.1.2. Supporting life cycle processes category**
...
_Table 10 — Supporting life cycle processes - SUP process group_
**3.1.3. Organizational life cycle processes category**
...
_Table 12 — Organizational life cycle processes - PIM process group_
...
_Table 13 — Organizational life cycle processes - REU process group_
**3.2. Measurement framework**
...
_Note: The Automotive SPICE measurement framework is an adaption of ISO/IEC 33020:2019. Text
...
products are appropriately established, controlled and maintained._
...
Table 14 — Process capability levels_
...
_Within this process measurement framework, a process attribute is a measureable property of
process capability. A process attribute rating is a judgement of the degree of achievement of the
process attribute for the assessed process._


© VDA Quality Management Center (^20)
The rating scale is shown in Table 16 — Rating scale.
_Note. The rating scale is identical to ISO/IEC 33020:
...
achievement of the process attribute may be unpredictable._
...
**_P-_** _Partially achieved - > 15% to ≤ 32.5% achievement_
**_P+_** _Partially achieved + > 32.5 to ≤ 50% achievement_
**_L-_** _Largely achieved - > 50% to ≤ 67.5% achievement_
**_L+_** _Largely achieved + > 67.5% to ≤ 85% achievement
Table 19 — Refined rating scale percentage values_
**3.2.3. Rating and aggregation method**
Rating and aggregation methods are taken from ISO/IEC 33020:2019, which provides the following
definitions:
_A process outcome is the observable result of successful achievement of the process purpose.
...
shall be specified in the assessment input and referenced in the assessment report._
ISO/IEC 33020:2019 provides the following 3 rating methods:
**_Rating method R1_**
_The approach to process attribute rating shall satisfy the following conditions:
...
aggregated to provide a process attribute achievement rating._
**_Rating method R2_**
_The approach to process attribute rating shall satisfy the following conditions:
...
provide a process attribute achievement rating._
**_Rating method R3_**


© VDA Quality Management Center (^22)
_Process attribute rating across assessed process instances shall be made without aggregation._
...
_When performing an assessment, ratings may be summarized across one or two dimensions.
For example, when rating a_

- _process attribute for a given process, one may aggregate ratings of the associated process_
    _(attribute) outcomes – such an aggregation will be performed as a vertical aggregation (one_
    _dimension)._
- _process (attribute) outcome for a given process attribute across multiple process instances,_
    _one may aggregate the ratings of the associated process instances for the given process_
    _(attribute) outcome such an aggregation will be performed as a horizontal aggregation (one_
    _dimension)_
- _process attribute for a given process, one may aggregate the ratings of all the process_
    _(attribute) outcomes for all the processes instances – such an aggregation will be performed_
    _as a matrix aggregation across the full scope of ratings (two dimensions)_
...
Largely or fully
Largely or fully
_Table 20 — Capability levels and corresponding process attribute ratings_
...
indicators:
**_Assessment Indicators_**
_A process assessment model shall be based on a set of assessment indicators that:
...
a)_ **_practices_** _that support achievement of either the process purpose or the specific process
attribute.
b)_ **_information items_** _and their characteristics that demonstrate the respective achievements.
c) resources and infrastructure that support the respective achievements.
[ISO/IEC 33004:2015, 6.3.1]_
...
**_information item_**
_separately identifiable body of information that is produced, stored, and delivered for human use
...
Note: Human use includes the information stored, managed and processed by a tool._
One common definition of the term “work product” is:
**_work product_**
_artifact resulting from the execution of a process
[ISO/IEC/IEEE 24765:2017]_
...
```
Execution Methods Process Assessment Model(s)
```
```
...
model
```
**Process ID** (^) The individual processes are identified with a unique process
...
_Note: Refer to Annex B for the characteristics of each
information item.
Table 21 — Template for the process description_
...
_Note 1: see SUP.9 for management of problems_
...
_Note 2: see MAN.5 for management of risks_
...
02 - 01 Commitment/Agreement X X X X
13 - 52 Communication evidence X X X
13 - 09 Meeting support evidence X X
13 - 14 Progress status X X
13 - 16 Change request X
13 - 19 Review evidence X
14 - 02 Corrective action X
15 - 5 1 Analysis results X
**Base Practices**
BP1: Agree on and maintain joint processes, joint interfaces, and information
to be exchanged X X^ X
BP2: Exchange all agreed information X X X
BP3: Review development work products with the supplier X X X
BP4: Review progress of the supplier X X X
BP 5 : Act to correct deviations X X
**4.2. Supply process group (SPL)
4.2.1. SPL.2 Product Release
Process ID
SPL.2
...
_Note 1: This may include the hardware elements, software elements, and extra application
parameter files (influencing the identified system functionality) that are needed for the release._
**SPL.2.BP2: Define release package.** Define the release as well as supporting tools and
information.
_Note 2: The release package may include also programming tools._
...
_Note 3: Unique identification may be realized by a classification and numbering scheme for product
releases._
...
_Note 4: This practice may be supported by the SUP.8 Configuration Management Process._
...
_Note 5: The release note may include information about legal aspects like relevant target markets,
legislation that is considered etc. See also VAL.1 Validation._
...
**SPL.2.BP8: Deliver the release package to the intended customer.** Deliver the rel ease package
to the intended customer.
_Note 6: The intended customer may be an internal organizational unit or an external organization._
**SPL.2 Product Release**
Outcome 1
Outcome 2
Outcome 3
...
Outcome 5
**Output Information Items**
11 - 03 Release note X X X X
11 - 04 Product release package X X
13 - 06 Delivery evidence X X
13 - 13 Product release approval X X
18 - 06 Product release criteria X X X


© VDA Quality Management Center (^33)
**Base Practices**
BP1: Define the functional content of releases X
BP2: Define release package X
BP3: Establish a product release classification and numbering scheme X
BP4: Build the release from configured items X
BP 5 : Ensure product release approval before delivery X
BP 6 : Provide a release note X X
BP 7 : Communicate the type, service level and duration of support for a
release X^ X
BP8: Deliver the release package to the intended customer X
...
_Note 1: Documenting the stakeholder, or the source of a stakeholder requirement, supports
stakeholder requirements agreement and change analysis (see BP2 and BP3)._
...
_Note 2: Examples of affected parties are customers, suppliers, design partners, joint venture
...
_Note 4: Requirements changes may arise from different sources as for instance changing
technology, stakeholder needs, or legal constraints.
Note 5: Refer to SUP.10 Change Request Management, if required._
...
13 - 52 Communication Evidence X X
17 - 00 Requirement X
17 - 54 Requirement Attribute X X X
**Base Practices**
BP1: Obtain stakeholder expectations and requests X
BP 2 : Agree on requirements X
BP 3 : Analyze stakeholder requirements changes X
BP 4 : Communicate requirements status X X
...
_Note 1: Characteristics of requirements are defined in standards such as ISO IEEE 29148, ISO
...
_Note 3: Examples for structuring criteria can be grouping (e.g., by functionality) or product variants
identification.
Note 4: Prioritization can be done according to project or stakeholder needs via e.g., definition of
release scopes. Please refer to SPL.2.BP1._
...
_Note 5: See MAN.3.BP3 for project feasibility and MAN.3.BP5 for project estimates.
Note 6: Technical feasibility can be evaluated based on e.g., platform or product line, or by means of
prototype development or product demonstrators._
...
stakeholder requirements.
_Note 7: Bidirectional traceability supports consistency, facilitates impact analyses of change
...
_Note 1: Examples of interactions of system elements are timing diagrams reflecting inertia of
mechanical components, processing times of ECUs, and signal propagation times of bus systems._
...
_Note 2: See MAN.3.BP3 for project feasibility and MAN.3.BP5 for project estimates.
...
line), a make-or-buy decision, or found in an evolutionary way (e.g., set-based design)._
...
_Note 7: Bidirectional traceability further supports consistency, and facilitates impact analysis of
...
physical end product. Such requirements are still subject to verification._
...
_Note 1: Examples on what a verification measure may focus are the timing dependencies of the
correct signal flow between interfacing system elements, or interactions between hardware and
software, as specified in the system architecture. The system integration test cases may focus on_
- _the correct signal flow between system items,_
- _the timeliness and timing dependencies of signal flow between system items,_
- _the correct interpretation of signals by all system items using an interface, and/or_
- _the dynamic interaction between system items._
...
_Note 6: Providing all necessary information from the test case execution in a summary enables other
parties to judge the consequences._
**SYS.4 System Integration and Integration Verification**
Outcome 1
Outcome 2
Outcome 3
...
**Base Practices**
BP1: Specify verification measures for system integration X
...
- the required verification infrastructure and environment setup.
_Note 1: The system verification measures may cover aspects such as thermal, environmental,
robustness/lifetime, and EMC._
...
_Note 3: See SUP.9 for handling verification results that deviate from expected results_
...
measures.
_Note 4: Bidirectional traceability supports consistency, and facilitates impact analysis of change
requests, and demonstration of verification coverage. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other._
...
_Note 5: Providing all necessary information from the test case execution in a summary enables other
parties to judge the consequences._
**SYS.5 System Verification**
Outcome 1
Outcome 2
...
13 - 52 Communication Evidence X
**Base Practices**
BP1: Specify verification measures for system verification X
BP2: Select verification measures X
BP3: Perform verification of the integrated system X
...
requirements.
_Note 5: Examples for structuring criteria can be grouping (e.g., by functionality) or expressing
product variants.
Note 6: Prioritization can be done according to project or stakeholder needs via e.g., definition of
release scopes. Refer to SPL.2.BP1._
**SWE.1.BP3: Analyze software requirements.** Analyze the specified software requirements
including their interdependencies to ensure correctness, technical feasibility, and to support
project management regarding project estimates.
_Note 7: See MAN.3.BP3 for project feasibility and MAN.3.BP5 for project estimates.
...
_Note 9: Redundant traceability is not intended.
...
ensured between stakeholder requirements and software requirements._
...
_Note 4: See MAN.3.BP3 for project feasibility and MAN.3.BP5 for project estimates.
...
software requirements.
_Note 9: There may be non-functional software requirements that the software architectural design
...
_Note 6: Examples for behavioral descriptions are natural language or semi-formal notation (e.g,
SysML, UML)._
...
_Note 7: Examples for coding principles at capability level 1 are not to use implicit type conversions,
only one entry and one exit point in subroutines, and range checks (design-by-contract, defensive
programming). Further examples see e.g, ISO 26262-6 clause 8.4.5 together with table 6._
...
_Note 8: Redundancy should be avoided by establishing a combination of these approaches.
...
_Note 1: Examples for unit verification measures are static analysis, code reviews, and unit testing.
Note 2: Static analysis can be done based on MISRA rulesets and other coding standards._
...
13 - 52 Communication Evidence X
**Base Practices**
BP1: Specify software unit verification measures X
BP2: Select software unit verification measures X
BP3: Verify software units X
BP4: Ensure consistency and establish bidirectional traceability for
software unit verification X^
BP5: Summarize and communicate results X
**4.4.5. SWE.5 Software Component Verification and Integration Verification
Process ID
SWE.5
...
- the required verification infrastructure and environment setup.
_Note 3: Verification measures are related to software components but not to the software units since
software unit verification is addressed in the process SWE.4 Software Unit Verification._
...
parties.
_Note 10: Providing all necessary information from the test case execution in a summary enables
other parties to judge the consequences._
...
component behavior X^
BP3: Select verification measures X
BP4: Integrate software elements and perform
integration verification^ X^ X^
BP5: Perform software component verification X
...
selection of verification measures shall have sufficient coverage according to the release scope_.
...
_Note 3: See SUP.9 for handling verification results that deviate from expected results._
...
13 - 52 Communication Evidence X
**Base Practices**
BP1: Specify verification measures for software verification X
BP2: Select verification measures X
...
_Note 7: Examples of sources of validation measures from which they can be derived are legal
...
13 - 52 Communication Evidence X
**Base Practices**
BP1: Specify validation measures X
BP2: Select validation measures X
BP3: Perform validation and evaluate results X
BP4: Ensure consistency and establish traceability. X
BP5: Summarize and communicate results X
...
_Note 1: Non-functional requirements may include relevant characteristics of the ODD and KPIs as
...
_Note 4: Examples for structuring criteria can be grouping (e.g., by functionality) or variants
identification.
...
_Note 6: See MAN.3.BP3 for project feasibility and MAN.3.BP5 for project estimates._
...
environment.
_Note 7: The ML operating environment is defined as the infrastructure and information which both
the trained ML model and the deployed ML model need for execution._
...
_Note 8: Bidirectional traceability supports consistency, facilitates impact analyses of change
requests, and verification coverage demonstration. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other.
Note 9: Redundant traceability is not intended, but at least one out of the given traceability paths._
...
_Note 1: Necessary details of the ML model may include layers, activation functions, and
...
_Note 3: Trustworthiness and explainability might be criteria for the analysis of the ML architectural
elements._
...
the ML requirements.
_Note 4: Bidirectional traceability supports consistency, and facilitates impact analyses of change
requests, and verification coverage demonstration. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other.
Note 5: The bidirectional traceability should be established on a reasonable level of abstraction to
the ML architectural elements._
...
BP 4 : Define interfaces of the ML architectural elements X
BP 5 : Define resource consumption objectives for the ML
architectural elements

### X

```
BP 6 : Ensure consistency and establish bidirectional traceability X
BP 7 : Communicate agreed ML architecture X
```
**4.6.3. MLE.3 Machine Learning Training**
...
_Note 1: The ML training and validation approach may include random dropout and other
...
Note 3: The training environment should reflect the environment of the deployed model._
...
_information is consistent with each other._
...
_Note 1: Expected test result per test datum might require labeling of test data to support comparison
...
weather conditions = sunny, street conditions = gravel road._
...
_Note 5: The ML test data set for the trained ML model might differ from the test data set of the
deployed ML model.
...
_Note 7: Evaluation of test logs might include pattern analysis of failed test data to support e.g.,
trustworthiness._
...
_Note 8: The deployed ML model will be integrated into the target system and may differ from the
trained ML model which often requires powerful hardware and uses interpretative languages._
...
_Note 9: Bidirectional traceability supports consistency, and facilitates impact analyses of change
requests, and verification coverage demonstration. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other._
...
_Note 1: Characteristics of requirements are defined in standards such as ISO IEEE 29148, ISO/IEC
...
requirements.
_Note 5: Examples for structuring criteria can be grouping (e.g., by functionality) or variants
identification.
Note 6: Prioritization can be done according to project or stakeholder needs via e.g., definition of
release scopes. Refer to SPL.2.BP1._
...
platform) or by prototype development._
...
refer to a given operating environment. In that case, consistency and bidirectional traceability can be
ensured between stakeholder requirements and hardware requirements._
...
15 - 51 Analysis Results X X
**Base Practices**^
BP1: Specify hardware requirements X
BP2: Structure hardware requirements X
BP3: Analyze hardware requirements X
BP4: Analyze the impact on the operating environment X
BP5: Ensure consistency and establish bidirectional
traceability
...
```
BP6: Communicate agreed hardware requirements X
```
**4.7.2. HWE.2 Hardware Design**
...
architecture.
_Note 1: Examples for aspects reflected in the hardware architecture are ground concept, supply
concept, EMC concept.
Note 2: Examples for a design rationale can be implied by the reuse of a standard hardware,
platform, or product line, respectively, or by a make-or-buy decision, or found in an evolutionary way._
...
_Note 3: The identification of hardware parts and their suppliers in the hardware bill of materials may
...
compliance of HW parts with industry standards such as AEC-Q, REACH._
...
_Note 5: Not all hardware elements have dynamic behavior that needs to be described._
...
_Note 6: Examples for technical aspects are manufacturability for production, suitability of pre-existing
...
quantitative or qualitative analyses such as FMEA._
...
_Note 8: There may be non-functional hardware requirements that the hardware design does not
trace to. Examples are development process requirements. Such requirements are still subject to
verification.
Note 9: Bidirectional traceability further supports consistency, and facilitates impact analysis of
change requests, and demonstration of verification coverage. Traceability alone, e.g, the existence
of links, does not necessarily mean that the information is consistent with each other._
...
Outcome 6
**Output Information Items**^
04 - 52 Hardware Architecture X
04 - 53 Hardware Detailed Design X
15 - 51 Analysis Results X
13 - 51 Consistency Evidence X
17 - 57 Special Characteristics X
13 - 52 Communication Evidence X
04 - 54 Hardware Schematics X X X
14 - 54 Hardware Bill of Materials X X X
04 - 55 Hardware Layout X^ X X^
03 - 54 Hardware Production Data X^ X X^
04 - 56 Hardware Element Interface X^
**Base Practices**^
BP1: Specify the hardware architecture X^ X^ X^
BP2: Specify the hardware detailed design X^ X^ X^
BP3: Specify dynamic aspects X^
...
- the required verification infrastructure and environment setup.
_Note 1: Examples on what a verification measure may focus on are the timeliness and timing
dependencies of the correct signal flow between interfacing hardware elements, interactions
between hardware components.
Note 2: Measuring points can be used for stepwise testing of hardware elements._
...
_Note 6: Bidirectional traceability supports consistency, and facilitates impact analysis of change
requests, and demonstration of verification coverage. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other._
**HWE.3.BP6: Summarize and communicate results.** Summarize the verification results and
communicate them to all affected parties.
_Note 7: Providing all necessary information from the test case execution in a summary enables other
parties to judge the consequences._
**HWE.3 Verification against Hardware Design**
Outcome 1
Outcome 2
...
hardware design X^
BP2: Ensure use of compliant samples X
BP3: Select verification measures X
BP4: Verify hardware design X
BP5: Ensure consistency and establish bidirectional traceability X X
BP6: Summarize and communicate results X
**4.7.4. HWE.4 Verification against Hardware Requirements
Process ID
HWE.4
Process name
...
- the required verification infrastructure and environment setup
_Note 1: The verification measures may cover aspects such as thermal, environmental,
robustness/lifetime, and EMC._
...
_Note 5: Bidirectional traceability supports consistency, and facilitates impact analysis of change
requests, and demonstration of verification coverage. Traceability alone, e.g., the existence of links,
does not necessarily mean that the information is consistent with each other._
...
_Note 1: Possible inputs for evaluating the independence may be assignment to financial and/or
organizational structure as well as responsibility for processes that are subject to quality assurance
(no self-monitoring)._
...
_Note 2: Quality criteria may consider internal and external inputs such as customer requirements,
standards, milestones, etc._
...
_Note 3: Quality assurance activities may include reviews, problem analysis and lessons learned that
improve the work products for further use._
...
results.
_NOTE 4: Quality assurance activities may include process assessments, problem analysis, regular
...
_NOTE 5: Non-conformances detected in work products may be entered into the problem resolution
management process (SUP.9).
NOTE 6: Non-conformances detected in the process definition or implementation may be entered
into a process improvement process (PIM.3)._
...
_NOTE 7: The decision whether to escalate non-conformances may be based on criteria such as
delay of resolution, urgency, and risk._
...
18 - 52 Escalation path X X
18 - 07 Quality criteria X X X
13 - 52 Communication evidence X X X
13 - 18 Quality conformance evidence X X
13 - 19 Review evidence X X
14 - 02 Corrective action X X
Base Practices
BP1: Ensure independence of quality assurance. X
BP2: Define criteria for quality assurance. X
BP 3 : Assure quality of work products. X X
BP 4 : Assure quality of process activities. X X
```

© VDA Quality Management Center (^81)
BP 5 : Summarize and communicate quality assurance activities
and results.
(^) X X X
BP 6 : Ensure resolution of non-conformances. X X
BP 7 : Escalate non-conformances. X X
**4.8.2. SUP.8 Configuration Management
Process ID
SUP.8
Process name
...
_NOTE 1: Configuration items are representing work products or group of work products which are
...
NOTE 3: The selection criteria may be applied to single work products or a group of work products._
...
_NOTE 4: The configuration item properties may be defined for single configuration items or a group
of items.
...
NOTE 6: The application of properties may be implemented by attributes of configuration items._
...
_NOTE 7: This may include specific mechanisms for different configuration item types, such as
branch and merge management, or checkout control._
**SUP.8.BP4: Control modifications.** Control modifications using the configuration management
mechanisms.
_NOTE 8: This may include the application of a defined status model for configuration items._
...
_NOTE 9: Regular communication of the configuration status, e.g., based on a defined status model
...
_NOTE 10: Completeness and consistency of a baseline means that all required configuration items
...
mechanisms.
_NOTE 11: Backup and recovery mechanisms may be defined and implemented by organizational
...
Outcome 8
**Output Information Items**^
18 - 53 Configuration item selection criteria X
01 - 52 Configuration item list X X X
16 - 03 Configuration management system X X X
13 - 08 Baseline X X


© VDA Quality Management Center (^83)
14 - 01 Change history X X X
15 - 56 Configuration status X
13 - 51 Consistency Evidence X
06 - 52 Backup and recovery mechanism information X
**Base Practices**
BP1: Identify configuration items X
BP2: Define configuration item properties X
BP3: Establish configuration management X X
BP4: Control modifications X
BP5: Establish baselines X
BP6: Summarize and communicate configuration status X
BP7: Ensure completeness and consistency X
BP8: Verify backup and recovery mechanisms availability X
**4.8.3. SUP.9 Problem Resolution Management
Process ID
SUP.9
Process name
...
_NOTE 1: Problems may relate to e.g., product, resources, or methods.
...
request management process (SUP.10)._
...
_NOTE 5: Problem categorization (e.g., light, medium, severe) may be based on severity, criticality,
urgency, etc._
...
_NOTE 6: Collected data may contain information about where the problems occurred, how and when
they were found, what their impacts were, etc._
**SUP.9 Problem Resolution Management**
Outcome 1
Outcome 2
Outcome 3
...
**Base Practices**
BP1: Identify and record the problem X X
BP2: Determine the cause and the impact of the problem X X
BP3: Authorize urgent resolution action X
BP4: Raise alert notifications X
BP5: Initiate problem resolution X
BP6: Track problems to closure X X
BP7: Report the status of problem resolution activities X
**4.8.4. SUP.10 Change Request Management
Process ID
SUP.10
Process name
...
_NOTE 1: Change requests may be used for changes related to e.g., product, process, methods.
NOTE 2: Example values for the change request status are “open”, “under investigation”,
“implemented”, etc.
NOTE 3 : The change request handling may differ across the product life cycle e.g., during prototype_


© VDA Quality Management Center (^86)
_construction and series development_
...
assessed.
_NOTE 4: Examples for analysis criteria are: resource requirements, scheduling issues, risks,
benefits, etc._
...
resources.
_NOTE 5: A Change Control Board (CCB) is an example mechanism used to approve change
requests.
NOTE 6: Prioritization of change requests may be done by allocation to releases._
...
_NOTE 7: Examples for informing affected parties can be daily standup meetings or tool-supported
workflows._
**SUP.10 Change Request Management**
Outcome 1
Outcome 2
...
13 - 16 Change request X X X X X
13 - 51 Consistency evidence X
**Base Practices**
BP1: Identify and record the change requests X
BP2: Analyze and assess change requests X
BP3: Approve change requests before implementation X
BP4: Establish bidirectional traceability X
BP5: Confirm the implementation of change requests X


© VDA Quality Management Center (^87)
BP6: Track change requests to closure X
**4.8.5. SUP.11 Machine Learning Data Management
Process ID
SUP.11
Process name
...
_Note 1: Supported ML data management activities may include data collection, labeling/annotation,
and structuring._
...
_Note 6: The identification and collection of ML data might be an organizational responsibility.
...
_Note 8: These activities may include sample-based reviews or statistical methods._
...
Outcome 5
**Output Information Items**
16 - 52 ML data management system X
19 - 50 ML data quality approach X
03 - 53 ML data X X
13 - 52 Communication evidence X
**Base Practices**
BP1: Establish an ML data management system X
BP2: Develop an ML data quality approach X
BP3: Collect ML data X
BP4: Process ML data X
BP5: Assure quality of ML data X
BP6: Communicate agreed processed ML data X
...
milestones.
_Note 1: This may include the alignment of the project life cycle with the customer's development
process._
...
_Note 2: The evaluation of feasibility may consider technical constraints of the project._
...
_Note 3: The structure and the size of the work packages support an adequate progress monitoring.
Note 4: Work packages may be organized in a work breakdown structure._
...
boundaries.
_Note 5: Examples of necessary resources are budget, people, product samples, or infrastructure
...
and work packages.
_Note 8: Training, mentoring or coaching of individuals may be applied to resolve deviations from
required skills and knowledge._
...
_Note 9: Affected stakeholders may include other projects, organizational units, sub-contractors, and
service providers._
...
_Note 10: This may include the consideration of critical dependencies, that are an input for risk
management._
...
_Note 11: Project reviews may be executed at regular intervals by the management. Project reviews
may contribute to identify best practices and lessons learned.
Note 12: Refer to SUP.9 for resolution of problems_
**MAN.3 Project Management**
Outcome 1
Outcome 2
Outcome 3
...
08 - 54 Feasibility analysis X X
...
13 - 51 Consistency evidence X X
14 - 02 Corrective action X X
18 - 52 Escalation path X X X
08 - 56 Schedule X X X
14 - 50 Stakeholder groups list X
15 - 06 Project status X X
**Base Practices**
BP1: Define the scope of work X
BP2: Define project life cycle X X
BP3: Evaluate feasibility of the project X
BP4: Define and monitor work packages X X X X
...
affected parties.
_Note 1: Risks may include technical, economical, and schedule risks.
Note 2: Risks may include the suppliers’ deliverables and services.
Note 3: The risk sources may vary across the entire project life cycle._
...
_Note 4: Different methods may be used to analyze technical risks of a system, for example,
functional analysis, simulation, FMEA, FTA etc._
...
_Note 5: Risks of high priority may need to be communicated to and monitored by higher levels of
management._
**MAN.5.BP7: Take corrective action.** When risk treatment activities are not effective, take
appropriate corrective action.
_Note 6: Corrective actions may involve reevaluation of risks, developing and implementing new
mitigation concepts or adjusting the existing concepts._
**MAN.5 Risk Management**
Outcome 1
Outcome 2
Outcome 3
...
Outcome 5
**Output Information Items**
15 - 51 Analysis results X X X X
15 - 09 Risk status X X X X
...
14 - 02 Corrective action X X
**Base Practices**
BP1: Identify sources of risks X
BP2: Identify potential undesirable events X
BP3: Determine risks X
BP4: Define risk treatment options X X
BP5: Define and perform risk treatment activities. X X
BP 6 : Monitor risks X
BP 7 : Take corrective action X
**4.9.3. MAN.6 Measurement
Process ID
MAN.6
Process name
...
_Note 1: Information needs may change over time. Therefore, the measurement process may be
used in an iterative way._
**MAN.6.BP2: Specify metrics.** Identify and develop an appropriate set of metrics based on
measurement information needs.
_Note 2: Metrics may be related to processes or development results._
...
_Note 3: Base metrics in the context of this process are directly gathered metrics like “number of
defects found” or “number of lines of code”, where derived metrics are two or more metrics that are
brought in relation to each other like “number of defects found per line of code”._
...
Outcome 5
**Output Information Items**
03 - 03 Benchmarking data X X
03 - 04 Customer satisfaction data X X
03 - 06 Process performance information X X
07 - 51 Measurement result X X X X
15 - 51 Analysis results X X X
**Base Practices**
BP1: Identify information needs X
BP2: Specify metrics X X
BP3: Collect and store metrics X X
BP4: Analyze collected metrics X X
BP5: Communicate measurement information X
BP6: Use metrics for decision-making X
...
_Note 1: The process improvement process is a generic process, which can be used at all levels (e.g,
...
Note 3: Enablers for improvement measures may include trainings, methods, infrastructure, etc._
...
_Note 4: Analysis may include problem report trend analysis (see SUP.9), analysis from Quality
...
_Note 7: The current status of processes may be determined by process assessment._
...
defined.
_Note 8: Improvements may be documented in incremental steps._
...
needed.
_Note 9: Process application can be supported by establishing policies, adequate process
infrastructure, process training, process coaching and tailoring processes to local needs.
Note 10: Improvements may be piloted before roll out within the organization._
...
07 - 04 Process metric X^ X^
10 - 00 Process description X^
13 - 52 Communication evidence X
13 - 16 Change request X
15 - 51 Analysis result X^ X^ X^ X^
15 - 13 Assessment/audit report X^ X^
15 - 16 Improvement opportunity X X X^
16 - 06 Process repository X
**Base Practices**
BP1: Establish commitment X
BP2: Identify improvement measures X^ X^
BP3: Establish process improvement goals X^


© VDA Quality Management Center (^97)
BP4: Prioritize improvements X^
BP5: Define process improvement measures X
BP6: Implement process improvement measures X
BP7: Confirm process improvement X
BP8: Communicate results of improvement X
**4.11. Reuse process group (REU)
4.11.1. REU.2 Management of Products for Reuse
Process ID
REU.2
...
_Note 1: Products for reuse may be systems, hardware or software components, third party
components or legacy components._
...
_Note 2: Examples for criteria can be requirements compliance, verifiability of the product to be
reused in the target architecture, or portability/interoperability._
**REU.2.BP3: Define limitations for reuse.** Define and communicate limitations for the products
to be reused.
_Note 3: Limitations may address parameters of operational environment._
...
_Note 4: Qualification may be demonstrated by verification evidence.
Note 5: Verification may include the appropriateness of documentation._
**REU.2.BP5: Provide products for reuse.** Make available the product to be reused to affected
parties.
_Note 6: Refer to HWE.3, SWE.5 or SYS.4 for more information on integration of hardware, software,
or system components._
...
_Note 7: The communication with the provider of a reused product may depend on whether the
product is under development or not._
**REU.2 Management of Products for Reuse**
Outcome 1
Outcome 2
Outcome 3
...
Outcome 6
**Output Information Items**
04 - 02 Domain architecture X X
12 - 03 Reuse candidate X X
13 - 52 Communication evidence X^
15 - 07 Reuse analysis evidence X^ X^
13 - 5 3 Qualification evidence X^
**Base Practices**
BP1: Select products for reuse X
BP2: Analyze the reuse capability of the product X^
BP3: Define limitations for reuse X^
BP4: Ensure qualification of products for reuse X^
BP5: Provide products for reuse X
...
Achievement a
Output Information Items^
Process specific information items, as described in chapter 4 X^
Generic practices^
...
_Note 1: Budget targets and delivery dates to the customer, targets for test coverage and process
lead time are examples for process performance objectives.
Note 2: Performance objectives are the basis for planning and monitoring._
...
_Note 3: A process performance strategy may not necessarily be document-ed specifically for each
process. Elements applicable for multiple processes may be documented jointly, e.g, as part of a
common project handbook or in a joint test strategy._
...
_Note 4: Schedule and milestones are defined._
...
_Note 5: Physical and material resources may include equipment, laboratories, materials, tools,
licenses etc._
...
_Note 6: The definition of responsibilities and authorities does not necessarily require formal role
descriptions._
...
responsibilities.
_Note 7: Qualification of individuals may include training, mentoring, or coaching._
...
18 - 58 Process performance objectives X
...
_Note 1: Possible sources of documentation requirements may be e.g., best practices or lessons
...
there would be no need to define the corresponding criteria._
...
_Note 3: Possible sources for the identification of requirements for storage and control may be e.g.,
...
_Note 1: An example for describing the involvement of the process roles in the activities is a
RASI/RASIC representation._
Suitable guidance, procedures, and templates are provided to support the execution of the
process as needed.
_Note 2: Procedures may also include description of specific methods to be used._
...
_Note 3: For guidance on how to perform process improvements see the Process Improvement
process (PIM.3)._
...
_Note 4: Qualification methods are e.g., trainings, mentoring, self-study.
...
_Note 6: This may include e.g., facilities, tools, licenses, networks, services, and samples supporting
the establishment of the required work environment._
...
process are determined.
_Note 7: Methods and activities to gather feedback regarding the standard process may be lessons
learned, process compliance checks, internal audits, management reviews, change requests,
reflection of state-of-the-art such as applicable international standards, etc._
Appropriate criteria and information needed to monitor the standard process are defined.
_Note 8: Information about process performance may be of qualitative or quantitative nature._
**PA 3.1 Process definition process attribute**
Achievement
1
Achievement
...
6
**Output Information Items**
06 - 51 Tailoring guideline X^
08 - 63 Process monitoring method X
10 - 00 Process description X X
10 - 50 Role description X
10 - 51 Qualification method description X
10 - 52 Process resource and infrastructure description X
**Generic Practices**
GP 3.1.1 Establish and maintain the standard process X X X X
GP 3.1.2 Determine the required competencies X
GP 3.1.3 Determine the required resources X
...
_Note 1: Changes in the standard process may require updates of the defined process._
...
_Note 2: For guidance on how to perform process improvements see the Process Improvement
process (PIM.3)._
**PA 3.2 Process deployment process attribute**
Achievement
1
...
**Output Information Items**
10 - 00 Process description X^
15 - 54 Tailoring documentation X
14 - 53 Role assignment X X
13 - 55 Process resource and infrastructure documentation X
03 - 06 Process performance information X
**Generic Practices**
GP 3.2.1 Deploy a defined process X
GP 3.2.2 Ensure required competencies X X
GP 3.2.3 Ensure required resources X
GP 3.2.4 Monitor the performance of the defined process X
...
_Note: Information needs typically reflect management, technical, project, process or product needs._
**Generic practices
...
_Note 1: Examples of process elements are work products, activities, tasks._
...
_Note 2: Typically, the standard process definition is extended to include the collection of data for
process measurement._
...
_Note 3: A product measure can contribute to a process measure, e.g., the productivity of testing
...
6
**Output Information Items**
18 - 70 Business goals X X
07 - 61 Quantitative process metric X X
07 - 62 Process analysis techniques X
07 - 63 Process control limits X
07 - 64 Process measurement data X
**Generic Practices**
GP 4.1.1 Identify business goals X
GP 4.1.2 Establish process information needs X
...
analysis techniques X X^
GP 4.1.5 Establish quantitative control limits X
GP 4.1.6 Collect product and process measurement results through
performing the de-fined process X
**5.5.2. PA 4.2 Quantitative control process attribute
Process attribute ID
PA 4.2
Process attribute name
...
_Note 1: Assignable cause may indicate a possible problem in the defined process._
**PA 4.2 Quantitative control process attribute**
Achievement 1
Achievement 2
Achievement 3
Achievement 4
**Output Information Items**
15 - 57 Quantitative process analysis results X X X
08 - 66 Measures against deviations in quantitative process analysis X
**Generic Practices**
GP 4.2.1 Identify variations in process performance X
GP 4.2.2 Identify causes of variation X X
...
3
**Output Information Items**
18-80 Improvement opportunity X X
15- 58 Common cause of variation analysis results X
**Generic Practices**
GP 5.1.1 Define the process innovation objectives for the process that support the
relevant business goals X^
GP 5.1.2 Analyze quantitative data of the process X
GP 5.1.3 Identify innovation opportunities X
...
Achievement c
**Output Information Items**
18- 81 Improvement evaluation results X X
08- 66 Measures against deviations in quantitative process analysis X X
**Generic Practices**
GP 5.2.1 Define and assess the impact of proposed changes X
GP 5.2.2 Implement agreed process changes X
GP 5.2.3 Evaluate the effectiveness of process change X
...
_[ISO/IEC 33004:2015, 5.5 and 6.4]_
...
_[ISO/IEC 33004:2015, 6.3.1 a, "Assessment indicators"]_
...
3300 3:2015 has been adopted from ISO/IEC 33020:2019.
...
_Table B.1 — Structure of information item characteristics (IIC) table_
**ID Name Characteristics
01- 03** Software component •^ Software element in the software architecture above the software unit
level.
...
**01- 50** Integrated software •^ Software executable (e.g, simulator with stubbing, debug-able, object
code) including:
...
```
01- 52 Configuration item list •^ Items under configuration control^
```
- The name of work products and an associated reference (to file, to tool
    artifact)
- Configuration item attributes and properties
**01- 53** Trained ML model •^ The trained ML model is the output of the training process. It consists of
...
hyperparameters.
**01- 54** Hyperparameter •^ Hyperparameters are used to control the ML model which has to be
trained, e.g.:
...
```
03- 51 ML data set •^ Selection of ML Data for e.g., ML model training (ML Training and
Validation Data Set) or test of the trained and deployed ML model (ML
Test Data Set).
03- 53 ML data •^ Datum to be used for Machine Learning. The datum has to be attributed
...
**04- 04** Software architecture •^ A justifying rationale for the chosen architecture.^
...
```
04- 06 System architecture •^ A justifying rationale for the chosen architecture.^
```
...
- Explanatory annotations, e.g., with natural language, for single
elements or entire diagrams/models.
**04- 51** ML architecture •^ An ML architecture is basically a special part of a software architecture
...
**04- 54** Hardware Schematics •^ Identifies the hardware parts^
...
**04- 55** Hardware Layout •^ Specifies the placement of the hardware parts and labels^
...
**06- 51** Tailoring guideline •^ Criteria for tailoring,^
...
```
07- 04 Process metric •^ Measurements about the process' performance:- ability to produce sufficient work products
```
...
```
07- 05 Project metric •^ Monitors key processes and critical tasks, provides status information
to the project on:
```
...
**ID Name** (^) **Characteristics
07- 06** Quality metric •^ Measures quality attributes of the work - functionality products defined:^
...
_Note: Refer ISO/IEC 25010 for detailed information on measurement
of product quality._

```
07- 08 Service level metric •^ Real time metrics taken while a system is operational, it measures the system's performance or expected service level
```
...
**ID Name** (^) **Characteristics
07- 51** Measurement result Result of gathering qualitative or quantitative data, e.g.,
Process metric
...
```
07- 63 Process control limits •^ Quantitative control limits for the quantitative process metrics^
```
```
...
```
08- 53 Scope of work •^ Summary of deliverables for a project^
```
...
**08- 54** Feasibility analysis •^ Statement about the ability of the project to achieve the project
...
- Identifies resource allocation, resource workload, and critical resources
    _NOTE: A schedule is consistent with the defined work packages, see 14-_
    _10_
...
```
08- 59 Validation Measure •^ A validation measure can be a test case, a measurement, a simulation,
...
**08- 60** Verification Measure •^ A verification measure can be a test case, a measurement, a
...
- Necessary sequence or ordering
**08- 61** Resource allocation •^ Detailed / named resources are allocated to process tasks^
- Overall resource workload is considered (e.g., allocation of resources to
multiple projects)
_NOTE: Work breakdown structure may be used to refine the detailed
resource allocation
...
**08- 64** ML test approach •^ The ML test approach describes^
...
**10- 00** Process description •^ Process description of a standard or defined process (e.g., after
tailoring), including:
...
```
10- 50 Role description •^ Name/identifier (unique within the organization)^
```
...
- Required services
- Required samples
**11- 03** Release note •^ Coverage for key elements (as appropriate to the application):^
...
**11- 50** Deployed ML model •^ It is derived from the trained ML model (see 01-53) and is to be
...
**12- 03** Reuse candidate •^ Identifies the product to be reused^
...
**13- 06** Delivery evidence •^ Evidence^ of items shipped/delivered electronically to customer^
- Identification of:
- to whom it was sent
...
- Is unique and may not be changed
    _NOTE: This should be established before a release to identify consistent_
    _and complete delivery_
...
© VDA Quality Management Center (^136)
**ID Name** (^) **Characteristics**

- Abstraction or summary of verification results
**13- 50** ML test results •^ Test^ data and logs^
...
_Note: This evidence can be accompanied by e.g., Definition of Done
(DoD) approaches._
...
_NOTE: The work package descriptions may be integrated into the/be
a part of a schedule, see 08- 56_

```
14- 50 Stakeholder groups list •^ Identifies:^
```
- involved parties
...
**14- 53** Role Assignment •^ Assignment of person(s) to roles^
...
```
15- 06 Project status •^ Status of in regards to progress and consistency of^ schedule, work item
...
© VDA Quality Management Center (^139)
**ID Name** (^) **Characteristics
15- 54** Tailoring
documentation
...
```
15- 56 Configuration status •^ Summary of configuration management records including relevant
status
```
...
© VDA Quality Management Center (^140)
**ID Name** (^) **Characteristics**
...
- Can be realized by means of tools.
    _NOTE: usage of requirements attributes may further support analysis of_
    _requirements._

```
17- 55 Resource needs •^ Identification of required resources for process performance^
```
- Staff including competencies, skills and authorities needs
- Material, equipment, and infrastructure
- Time and budget
    _NOTE: Needs are derived from Work Breakdown structure and schedule_
...
© VDA Quality Management Center (^141)
**ID Name** (^) **Characteristics**
...
- Special characteristics shall be verifiable according to VDA vol. 1
    _NOTE: A typical method for identifying and rate special characteristics is_
    _an FMEA._
...
```
18- 07 Quality criteria •^ Defines the expectations for work products^ and process performance^
```
...
**18- 52** Escalation path •^ Defined mechanisms to report and confirm escalation relevant issues^
...
© VDA Quality Management Center (^142)
**ID Name** (^) **Characteristics
...
```
18- 70 Business goals •^ Explanation of the business goals^
```
...
_Table B.2 — Information Item Characteristics_
...
### MAN.3ACQ.4 SUP.1SUP.8SUP.9SUP.10

```
SYS : System engineering
SW E : Software engine ering
...
© VDA Quality Management Center (^144)
**Annex C.2 "Element", "Component", and "Unit"**
...
```
SW E.2
Soft wa re A rc hite c tur al
Design
```
```
SW E.3
Software Detailed D esign
and Unit Construction
```
### SW E.4

```
Software Uni t Verification
```
### SW E.5

```
Software Component Verification
and Integration Ve rification
```
### SW E.6
...
Integration Test”.
_Figure C.3 — Integration of MLE Processes_
...
© VDA Quality Management Center (^146)
...
Integration Test”.
_Figure C.4 — Interdependencies within MLE and SUP.11_


© VDA Quality Management Center (^147)
**Annex C.4 Example of an ML Architecture**
...
_Figure C.5 — Example of an ML Architecture_
...
© VDA Quality Management Center (^148)
**Annex C.5 Traceability and consistency
SYS.2 BP5
SWE.1 BP5
SYS.5 BP4
...
SW architecture
SW detailed de sign
SW Unit Unit verificationresults**
...
```
```
Verification measures Verification results
```
```
Verification
measures
...
ML training and
validation data set
MLE.4 BP6 ML t est ap p roach
MLE.4 BP6 ML test data set
MLE.4 BP6 ML test results
Consistency and bidirectional traceability
bidirectional traceability**
_Figure C.4 — Consistency and traceability between ML work products_
...
- “ _to find the size, quantity, etc. of something in standard units, ‘size/quantity’”_ and “ _... to judge_
    _the importance, value or effect of something_ ”, respectively
- “ _a plan of action or something done_ ”
...
© VDA Quality Management Center (^153)
**Annex D Reference standards**
...
ISO/IEC 33004:201 9 Information technology -- Process assessment –
...
capability
ISO/IEC/IEEE 24765:201 7 Systems and software engineering -- Vocabulary
...
2018 - 12
_Table D.1 — Reference standards_
